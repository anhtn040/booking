...
import { IComment } from "apis/public/residences/interface";
      ...
      <div className="flex-grow">
        <div className="flex justify-between space-x-3">
          ...
          <div className="flex text-yellow-500">
            {data.rating > 0 && <StarIcon className="w-4 h-4" />}
            {data.rating > 1 && <StarIcon className="w-4 h-4" />}
            {data.rating > 2 && <StarIcon className="w-4 h-4" />}
            {data.rating > 3 && <StarIcon className="w-4 h-4" />}
            {data.rating > 4 && <StarIcon className="w-4 h-4" />}
          </div>
        </div>
