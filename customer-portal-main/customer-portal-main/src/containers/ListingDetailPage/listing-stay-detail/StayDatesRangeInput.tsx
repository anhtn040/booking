...
import { getDateAfterTomorrow, getDateTomorrow } from "utils/dateHandle";
...
const StayDatesRangeInput: FC<StayDatesRangeInputProps> = ({
  className = "flex-1",
  start = getDateTomorrow(),
  end = getDateAfterTomorrow()
}) => {
  ...
  const onChangeDate = (dates: [Date | null, Date | null]) => {
    ...
    setStartDate(start === null ? getDateTomorrow() : start);
    setEndDate(end === null ? getDateAfterTomorrow() : end);
  };
