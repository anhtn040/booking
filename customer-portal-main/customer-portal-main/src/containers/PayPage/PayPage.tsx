      ...
      <div className="w-full flex flex-col sm:rounded-2xl sm:border border-neutral-200 dark:border-neutral-700 space-y-8 px-0 sm:p-6 xl:p-8">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col justify-between sm:flex-row sm:items-center">
            ...
            <QRCode bgColor="#f0f0f0" status="active" className="bg-gray dark:bg-white rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl" type="svg" value="https://ant.design/" />
         ...
         {/* ------------------------ */}
         <div className="space-y-6">
          <h3 className="text-2xl font-semibold">Thông tin khách sạn</h3>
          <div className="flex flex-col space-y-4">
            <div className="flex text-neutral-6000 dark:text-neutral-300">
              <span className="flex-1">Mã đặt phòng</span>
        ...
        <div className="flex justify-end">
          <ButtonPrimary href="/">Lịch sử đặt phòng</ButtonPrimary>
        </div>
      </div>
    );
  };
