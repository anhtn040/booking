...
import PageSignUp from "containers/PageForgotPassword/PageForgotPassword";
...
export const pages: Page[] = [
  ...
  //
  { path: "/residences", component: ListingStayPage },
  { path: "/residences/:id", component: ListingStayDetailPage },
  //
  { path: "/experience", component: PageAddListing3 },
  { path: "/experiences", component: AuthorPage },
  //
  { path: "/tours", component: ListingRealEstatePage },
  //
  { path: "/services", component: ListingExperiencesPage },
  //
  { path: "/discovery", component: ListingExperiencesPage },
  //
  ...
  //
  { path: "/ships", component: ListingFlightsPage },
  //
  ...
  { path: "/forgot-password/:token", component: PageSignUp },
